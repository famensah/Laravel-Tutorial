...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar sticky-top navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <!-- ============================================================== -->
                        <!-- <li class="dropdown">
                            <a class="profile-pic dropdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" href="#">
                                <img src="{{asset('assets/plugins/images/users/varun.jpg')}}" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium">{{Auth::user()->name }}</span></a>
                        </li> -->
                        <div class="dropdown">
                            <div class="profile-pic dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <!-- <img src="{{ storage_path() . '/' . Auth::user()->avatar_path }}" alt="user-img" width="36"
                                    class="img-circle"/> -->
                            <img src="{{ asset('storage/' . Auth::user()->avatar_path ) }}" alt="user-img" width="36"
                                    class="img-circle"/>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                 @csrf
                                    <li><input class="dropdown-item" type="submit" value="Log out"/></li>
                                </form>
                            </ul>
                        </div>
                        <!-- ============================================================== -->
                ...
                <nav class="sidebar-nav sticky-top">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('tasks.index')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <div class="sidebar-link waves-effect waves-dark sidebar-link">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <input class="btn p-0 m-0 hide-menu" type="submit" value="Log out"/>
                                </form>   
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-flex d-md-flex">
                            ...
                            data-bs-toggle="modal" data-bs-target="#ModalCreate"
                                class="btn btn-danger d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Add New Task</button>
                            @endcan
                        </div>
                    </div>
                </div>
