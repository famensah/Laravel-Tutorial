<x-app-layout>
    ...
    <div class="shadow-md rounded-lg w-[100%] lg:w-[70vw] sm:w-[60%] p-[3rem] bg-white mt-[3rem] flex flex-col items-center mx-auto">
        ...
        @endif
    <form method="POST" action="{{ route('tasks.update', ['task'=>$task]) }}" class="w-[70%] max-w-[500px]">
        @csrf
        @method('PATCH')
        ...
        <div>
            ...
            <textarea id="description" class="block mt-1 p-4 w-full rounded-md border-1 border-slate-300 my-1" name="description" autofocus >
        ...
        <div class="mt-4">
            ...
            <x-text-input id="department" class="block mt-1 w-full" type="text" name="department" :value="old('department', $task->department)" />
